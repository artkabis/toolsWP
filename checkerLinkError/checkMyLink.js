(function($){
   '<style>.succes{position:relative}.success:before{position:absolute;content:"Lien valide";background:"green";bottom:-125%;left:0;padding:0 5px;}.error{position:relative;}.error:before{position:absolute;content:"Erreur";left:0;bottom:-125%;background:red;padding:0 5px;}.error404:before{content:"Erreur 404"}.error418:before{content:"Erreur 418"}.error503:before{content:"Erreur 503"}</style>');
...
links.each(function () {
    ...
    $.ajax({
        ...
        success: function () { //ajout de la classe succes si la requête est valide
