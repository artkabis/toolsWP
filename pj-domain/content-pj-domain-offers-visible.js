...
const highlightResults = (node, offer) => {
  ...
  if (existingTextElement) {
    ...
    if (offer == "Essentiel" && !node.classList.contains('pjSearchColor') &&  !node.classList.contains('pagesjaunes')) {
    ...
    } else if (offer == "Premium" && !node.classList.contains('pjSearchColor')) {
    ...
    } else if (offer == "Privilege" && !node.classList.contains('pjSearchColor')) {
    ...
    } else if (offer == "Minisite" && !node.classList.contains('pjSearchColor')) {
    ...
    } else if (offer == "LandingPage" && !node.classList.contains('pjSearchColor')) {
    ...
    } else if (offer == "LeadFormance" && !node.classList.contains('pjSearchColor')) {
    ...
    } else if (offer == "Mappy" && !node.classList.contains('mappy')) {
    ...
    } else if (offer == "118712" && !node.classList.contains('pjSearchColor')) {
      node.style.backgroundColor = "rgb(19 255 66 / 39%)";
      node.style.boxShadow = "0px 0px 10px 7px rgb(19 255 66 / 39%)";
      createTextOffer(node, 'offre118712', '118712');
    } else if (offer == "LocalPartner" && !node.classList.contains('pjSearchColor')) {
    ...
    } else if ((offer == "PagesJaunes" || node.classList.contains('pagesjaunes')) && !node.classList.contains('pjSearchColor')) {
