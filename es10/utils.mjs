...
export export const onMutation = ({observerConfig = {childList: true,subtree: true,},element = document.body,callbackFunction}) =>{ const observer = new MutationObserver(callback);observer.observe(element, observerConfig);}
