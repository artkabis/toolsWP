...
export const stringInArray =(str,arr) =>{ const validArray =Array.isArray(arr), validStr=(typeof str ==='string');(validArray&&validStr ) ?  arr.includes(str) : console.error('Arguments not valid : ',(!validArray) ? arr+' not a Array' : str+' not a String')};
