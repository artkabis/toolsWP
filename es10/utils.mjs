...
export const stringInArray =(str,arr) =>{ const validStr=(typeof str ==='string'),validArray =Array.isArray(arr);return (validArray && validStr ) ?  arr.includes(str) : throw Error('Arguments not valid : ',(!validArray) ? arr+' not a Array' : str+' not a String')};
