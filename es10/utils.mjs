...
export const stringInArray =(str,arr) =>{ const validStr=(typeof str ==='string'),validArray =Array.isArray(arr);console.log(validStr,validArray);(validArray&&validStr ) ?  arr.includes(str) : console.error('Arguments not valid : ',(!validArray) ? arr+' not a Array' : str+' not a String')};
